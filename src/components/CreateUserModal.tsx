...
//     fd.append('vendorString', JSON.stringify(formData));

//     const userDocArray = [
//       ...frontDocs.map((f) => ({ imageName: f.name, idtype: 'AADHAR_CARD', frontSide: true })),
//       ...backDocs.map((f) => ({ imageName: f.name, idtype: 'AADHAR_CARD', frontSide: false })),
//       ...gstDocs.map((f) => ({ imageName: f.name, idtype: 'GST', frontSide: true })),
//       ...gumastaDocs.map((f) => ({ imageName: f.name, idtype: 'GUMASTA', frontSide: true })),
//     ];
//     fd.append('userDocumentString', JSON.stringify(userDocArray));

//     [...frontDocs, ...backDocs, ...gstDocs, ...gumastaDocs].forEach((file) =>
...
//             <select name="state" value={formData.state} onChange={handleChange} className="input"><option>Select State</option></select>
//             <select name="city" value={formData.city} onChange={handleChange} className="input"><option>Select City</option></select>
//           </div>
